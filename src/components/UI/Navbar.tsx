...
const Navbar = () => {
    return (
        <Flex position="fixed" py="2" className="w-full z-40 justify-between items-center bg-white bg-opacity-70 dark:bg-opacity-70 backdrop-blur-md border-b border-gray-400/30 dark:bg-black select-none px-2">
